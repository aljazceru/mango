...
Plans:
- [ ] 26-01-PLAN.md — Add SettingsProviders + SettingsDefaults Screen variants to Rust, regenerate UniFFI bindings
- [ ] 26-02-PLAN.md — iOS + Android: extract Providers/Defaults into sub-screens, add summary rows and routing
- [ ] 26-03-PLAN.md — Desktop: extract Providers/Defaults into sub-screen view modules, add summary rows and routing
**UI hint**: yes
