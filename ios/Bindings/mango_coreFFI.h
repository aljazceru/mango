...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_MANGO_CORE_FN_METHOD_FFIAPP_CONFIRM_DELETE_ALL_DATA
#define UNIFFI_FFIDEF_UNIFFI_MANGO_CORE_FN_METHOD_FFIAPP_CONFIRM_DELETE_ALL_DATA
RustBuffer uniffi_mango_core_fn_method_ffiapp_confirm_delete_all_data(uint64_t ptr, RustBuffer auth, int8_t backup_risk_acknowledged, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_MANGO_CORE_FN_METHOD_FFIAPP_CONFIRM_FORGET_MANAGED_PPQ
#define UNIFFI_FFIDEF_UNIFFI_MANGO_CORE_FN_METHOD_FFIAPP_CONFIRM_FORGET_MANAGED_PPQ
RustBuffer uniffi_mango_core_fn_method_ffiapp_confirm_forget_managed_ppq(uint64_t ptr, RustBuffer auth, int8_t backup_risk_acknowledged, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_MANGO_CORE_FN_METHOD_FFIAPP_CREATE_PPQ_RECOVERY_BACKUP
#define UNIFFI_FFIDEF_UNIFFI_MANGO_CORE_FN_METHOD_FFIAPP_CREATE_PPQ_RECOVERY_BACKUP
RustBuffer uniffi_mango_core_fn_method_ffiapp_create_ppq_recovery_backup(uint64_t ptr, RustBuffer backup_password, RustBuffer auth, RustCallStatus *_Nonnull out_status
);
#endif
...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_MANGO_CORE_CHECKSUM_METHOD_FFIAPP_CONFIRM_DELETE_ALL_DATA
#define UNIFFI_FFIDEF_UNIFFI_MANGO_CORE_CHECKSUM_METHOD_FFIAPP_CONFIRM_DELETE_ALL_DATA
uint16_t uniffi_mango_core_checksum_method_ffiapp_confirm_delete_all_data(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_MANGO_CORE_CHECKSUM_METHOD_FFIAPP_CONFIRM_FORGET_MANAGED_PPQ
#define UNIFFI_FFIDEF_UNIFFI_MANGO_CORE_CHECKSUM_METHOD_FFIAPP_CONFIRM_FORGET_MANAGED_PPQ
uint16_t uniffi_mango_core_checksum_method_ffiapp_confirm_forget_managed_ppq(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_MANGO_CORE_CHECKSUM_METHOD_FFIAPP_CREATE_PPQ_RECOVERY_BACKUP
#define UNIFFI_FFIDEF_UNIFFI_MANGO_CORE_CHECKSUM_METHOD_FFIAPP_CREATE_PPQ_RECOVERY_BACKUP
uint16_t uniffi_mango_core_checksum_method_ffiapp_create_ppq_recovery_backup(void
...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_MANGO_CORE_CHECKSUM_METHOD_FFIAPP_RESTORE_PPQ_RECOVERY_BACKUP
#define UNIFFI_FFIDEF_UNIFFI_MANGO_CORE_CHECKSUM_METHOD_FFIAPP_RESTORE_PPQ_RECOVERY_BACKUP
uint16_t uniffi_mango_core_checksum_method_ffiapp_restore_ppq_recovery_backup(void
